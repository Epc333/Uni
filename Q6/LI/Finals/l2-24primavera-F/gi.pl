...
subs(_, [], []) :- !.
subs([X,Y], [[X,Y] | G], [[Y,X] | H]) :- subs([X,Y], G, H), !.
subs([Y,X], [[X,Y] | G], [[Y,X] | H]) :- subs([X,Y], G, H), !.
subs([X,Y], [[X,Z] | G], [[Y,Z] | H]) :- subs([X,Y], G, H), !.
subs([X,Y], [[Z,X] | G], [[Z,Y] | H]) :- subs([X,Y], G, H), !.
subs([X,Y], [[Y,Z] | G], [[X,Z] | H]) :- subs([X,Y], G, H), !.
subs([X,Y], [[Z,Y] | G], [[Z,X] | H]) :- subs([X,Y], G, H), !.
subs([X,Y], [[U,V] | G], [[U,V] | H]) :- subs([X,Y], G, H), !.
