...
main :-
    estadoInicial(EstadoInicial), estadoFinal(EstadoFinal), topoMaxCost(Max),
...
unPaso(Coste, [X, Y], [X1, Y]) :-   X1 is X + 1, topoMap(M), nth1(X1, M, Row), nth1(Y, Row, El), El \= x, costPos(El, Coste).
unPaso(Coste, [X, Y], [X1, Y]) :-   X1 is X - 1, topoMap(M), nth1(X1, M, Row), nth1(Y, Row, El), El \= x, costPos(El, Coste).
unPaso(Coste, [X, Y], [X, Y1]) :-   Y1 is Y + 1, topoMap(M), nth1(X, M, Row), nth1(Y1, Row, El), El \= x, costPos(El, Coste).
unPaso(Coste, [X, Y], [X, Y1]) :-   Y1 is Y - 1, topoMap(M), nth1(X, M, Row), nth1(Y1, Row, El), El \= x, costPos(El, Coste).
