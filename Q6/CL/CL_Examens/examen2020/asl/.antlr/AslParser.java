...
public class AslParser extends Parser {
	...
	public static final int
		...
		OF=43, SUM=44, FILTER=45, INTO=46, USING=47, ID=48, INTVAL=49, FLOATVAL=50, 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'array'", "'of'", "'sum'", "'filter'", "'into'", "'using'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ENDFUNC", "READ", "WRITE", "ARRAY", "OF", "SUM", "FILTER", "INTO", "USING", 
	...
	public final StatementsContext statements() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 285066643111936L) != 0)) {
				{
				{
				setState(89);
				statement();
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4274901226323970L) != 0)) {
					{
					setState(118);
					expr(0);
					setState(123);
