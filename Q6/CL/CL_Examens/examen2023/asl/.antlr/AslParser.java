...
public class AslParser extends Parser {
	...
	public static final int
		...
		OF=43, FOREACH=44, ENDFOR=45, IN=46, REDUCE=47, ID=48, INTVAL=49, FLOATVAL=50, 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'array'", "'of'", "'foreach'", "'endfor'", "'in'", "'reduce'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ENDFUNC", "READ", "WRITE", "ARRAY", "OF", "FOREACH", "ENDFOR", "IN", 
			"REDUCE", "ID", "INTVAL", "FLOATVAL", "CHARVAL", "STRING", "COMMENT", 
			"WS"
		};
	}
	...
	public final StatementsContext statements() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 302658829156352L) != 0)) {
				{
				{
				setState(89);
				statement();
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4362862156546050L) != 0)) {
					{
					setState(126);
					expr(0);
					setState(131);
	...
	public static class ReduceContext extends ExprContext {
		public TerminalNode REDUCE() { return getToken(AslParser.REDUCE, 0); }
